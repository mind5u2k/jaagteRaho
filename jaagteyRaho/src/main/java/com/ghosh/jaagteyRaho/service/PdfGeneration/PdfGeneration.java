...
public class PdfGeneration {
	...
	public static void generateEmployeeSitePdf(HttpServletResponse response,
			List<SiteEmpReport> reports) throws DocumentException {
		response.setContentType("application/pdf");
		Document document = new Document(PageSize.A4.rotate());
		ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
		PdfWriter writer = PdfWriter.getInstance(document,
		...
		table.setWidths(columnWidths);
		cell = new PdfPCell(
				new Phrase(new Chunk("Employee-Site Report", font1)));
		cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		cell.setHorizontalAlignment(Element.ALIGN_CENTER);
		cell.setBorderWidth(0f);
		cell.setBorderWidthBottom(.5f);
		...
		table = new PdfPTable(7);
		table.setWidthPercentage(100);
		columnWidths = new float[] { 0.7f, 3f, 3f, 3f, 3f, 7f, 8f };
		table.setWidths(columnWidths);
		Font font = new Font(Font.FontFamily.UNDEFINED, 10);
		cell = new PdfPCell(new Phrase(new Chunk("#", font)));
		cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		...
		cell.setPaddingBottom(9);
		table.addCell(cell);
		cell = new PdfPCell(new Phrase(new Chunk("Site Address", font)));
		cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		cell.setHorizontalAlignment(Element.ALIGN_LEFT);
		cell.setBorderWidth(0f);
		cell.setBorderWidthBottom(0.5f);
		...
		cell.setBackgroundColor(new BaseColor(207, 207, 207));
		table.addCell(cell);
		cell = new PdfPCell(new Phrase(new Chunk("Assigned Employees", font)));
		cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		cell.setHorizontalAlignment(Element.ALIGN_LEFT);
		cell.setBorderWidth(0f);
		cell.setBorderWidthBottom(0.5f);
		...
		for (SiteEmpReport report : reports) {
			...
			cell.setPaddingBottom(9);
			table.addCell(cell);
			cell = new PdfPCell(new Phrase(new Chunk(report.getSite()
					.getSiteCode(), font)));
			cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
			cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell.setBorderWidth(0f);
			...
			cell = new PdfPCell(new Phrase(new Chunk(employees, font)));
			cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
			cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell.setBorderWidth(0f);
			cell.setBorderWidthBottom(0.5f);
	...
	public static void generateDesignationsPdf(HttpServletResponse response,
			List<Designation> designations) throws DocumentException {
		response.setContentType("application/pdf");
		Document document = new Document(PageSize.A4.rotate());
		ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
		PdfWriter writer = PdfWriter.getInstance(document,
		...
		float[] columnWidths = new float[] { 1f };
		table.setWidths(columnWidths);
		cell = new PdfPCell(new Phrase(new Chunk("Designations", font1)));
		cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		cell.setHorizontalAlignment(Element.ALIGN_CENTER);
		cell.setBorderWidth(0f);
		cell.setBorderWidthBottom(.5f);
		...
		table.setWidthPercentage(100);
		columnWidths = new float[] { 0.7f, 3f, 3f };
		table.setWidths(columnWidths);
		Font font = new Font(Font.FontFamily.UNDEFINED, 10);
		cell = new PdfPCell(new Phrase(new Chunk("#", font)));
		cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		...
		cell.setPaddingBottom(9);
		table.addCell(cell);
		cell = new PdfPCell(new Phrase(new Chunk("Designation Code", font)));
		cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		cell.setHorizontalAlignment(Element.ALIGN_LEFT);
		cell.setBorderWidth(0f);
		cell.setBorderColor(new BaseColor(233, 233, 233));
		...
		cell.setPaddingBottom(9);
		table.addCell(cell);
		cell = new PdfPCell(new Phrase(new Chunk("Designation Name", font)));
		cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		cell.setHorizontalAlignment(Element.ALIGN_LEFT);
		cell.setBorderWidth(0f);
		cell.setBorderColor(new BaseColor(233, 233, 233));
		...
		for (Designation designation : designations) {
			...
			cell = new PdfPCell(new Phrase(new Chunk(
					designation.getDesignationCode(), font)));
			cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
			cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell.setBorderWidth(0f);
			cell.setBorderWidthBottom(0.5f);
			...
			table.addCell(cell);
			cell = new PdfPCell(new Phrase(new Chunk(
					designation.getDesignationName(), font)));
			cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
			cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell.setBorderWidth(0f);
			cell.setBorderWidthBottom(0.5f);
	...
	public static void generateContactsPdf(HttpServletResponse response,
			List<ContactPerson> contactPersons) throws DocumentException {
		response.setContentType("application/pdf");
		Document document = new Document(PageSize.A4.rotate());
		ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
		PdfWriter writer = PdfWriter.getInstance(document,
		...
		float[] columnWidths = new float[] { 1f };
		table.setWidths(columnWidths);
		cell = new PdfPCell(new Phrase(new Chunk("Contact Persons", font1)));
		cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		cell.setHorizontalAlignment(Element.ALIGN_CENTER);
		cell.setBorderWidth(0f);
		cell.setBorderWidthBottom(.5f);
		...
		table.setWidthPercentage(100);
		columnWidths = new float[] { 0.7f, 3f, 3f, 3f };
		table.setWidths(columnWidths);
		Font font = new Font(Font.FontFamily.UNDEFINED, 10);
		cell = new PdfPCell(new Phrase(new Chunk("#", font)));
		cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		...
		cell.setPaddingBottom(9);
		table.addCell(cell);
		cell = new PdfPCell(new Phrase(new Chunk("Alternate Contact No", font)));
		cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		cell.setHorizontalAlignment(Element.ALIGN_LEFT);
		cell.setBorderWidth(0f);
		cell.setBorderColor(new BaseColor(233, 233, 233));
		...
		for (ContactPerson contactPerson : contactPersons) {
			...
			cell.setPaddingBottom(9);
			table.addCell(cell);
			cell = new PdfPCell(new Phrase(new Chunk(contactPerson.getName(),
					font)));
			cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
			cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell.setBorderWidth(0f);
			...
			table.addCell(cell);
			cell = new PdfPCell(new Phrase(new Chunk(
					contactPerson.getContactNo(), font)));
			cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
			cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell.setBorderWidth(0f);
			cell.setBorderWidthBottom(0.5f);
			...
			table.addCell(cell);
			cell = new PdfPCell(new Phrase(new Chunk(
					contactPerson.getAlternateNo(), font)));
			cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
			cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell.setBorderWidth(0f);
			cell.setBorderWidthBottom(0.5f);
