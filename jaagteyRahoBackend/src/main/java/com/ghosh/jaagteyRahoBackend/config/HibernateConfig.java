package com.ghosh.jaagteyRahoBackend.config;
...
@Configuration
@ComponentScan(basePackages = { "com.ghosh.jaagteyRahoBackend.dto" })
@EnableTransactionManagement
public class HibernateConfig {

	// Change the below based on the DBMS you choose
	// private final static String DATABASE_URL =
	// "jdbc:mysql://localhost:3306/code7pro_jaagteyRaho?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull";
	...
	public SessionFactory getSessionFactory(DataSource dataSource) {
		...
		builder.scanPackages("com.ghosh.jaagteyRahoBackend.dto");
